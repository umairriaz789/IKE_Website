    ...
    IERC20Errors
{
    ...
    // mapping(uint256 id => mapping(address account => uint256)) private _balancesOfToken;
    ...
    function TotalSupplyToContract(
        address _address
...
contract USDT is ERC20Permit {
    ...
    AggregatorV3Interface internal priceFeedofCHTToken;
    event TokenCreated(string _name);

    receive() external payable {
        revert();
    }
    constructor() ERC20Permit("USDT","USDT") { 
