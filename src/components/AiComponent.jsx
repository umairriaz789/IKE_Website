            ...
            <ScrollContainer>
                <ScrollPage>
                    <Animator animation={batch(Fade(), Sticky(), MoveOut(0, -200))}>
                        <span style={{ fontSize: "30px" }}>Intelligence for Your Tokenized Assets</span>
                    </Animator>
                </ScrollPage>
                <ScrollPage>
                    <Animator animation={ZoomInScrollOut}>
                        <span style={{ fontSize: "40px" }}>Smart Insights, Smarter Investments</span>
                    </Animator>
                </ScrollPage>
                <ScrollPage>
                    <Animator animation={FadeUp}>
                        <Animator animation={MoveIn(-1000, 0)}>
                            <p className={`${styles.paragraph} leading-[24px] text-[26px] mt-5 `}>
                        ...
                        <Animator animation={MoveIn(1000, 10)}>
                            <p className={`${styles.paragraph} leading-[24px] text-[26px]`}>
