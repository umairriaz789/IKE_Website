  ...
  const repay = async () => {
    try {
      if (isConnected) {
        ...
        let checkAllowance = await chrysusContract.allowance(address, LOAN);
        ...
        let Txn = await loanContract.repay(
          _collateral,
          ethers.utils.parseUnits(String(amount)),
        );
        await Txn.wait();
    ...
    <>
      <Section>
        <div className="min-h-screen d-flex align-items-start justify-content-center ">
          <div
            className="row col-md-6 mx-auto"
          ...
          >
            ...
            >
              <div className="mt-5" />
              <h4 className="text-baseAssets">Repay CHC</h4>
              <div className="d-flex flex-column align-items-center">
                <P className="m-0">How many CHC would you like to Repay?</P>
                <div className="my-3" />
                <label className="form-label" style={{ color: "#EDC452" }}>
                  Total Amount Borrowed : {}
                  {collateral == "DAI"
                    ? Number(dai_chcBalance).toFixed(4)
                    : Number(eth_chcBalance).toFixed(4)}
                  CHC
                </label>
                <div
