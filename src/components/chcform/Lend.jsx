  ...
  const lend = async () => {
    try {
      if (isConnected && amount) {
        ...
        let Txn = await loanContract.lend(
          ethers.utils.parseUnits(String(amount)),
          _collateral,
        );
        await Txn.wait();
      ...
      <div className="min-h-screen d-flex align-items-start justify-content-center">
        ...
        >
          <div className="col-md-6">
            ...
            >
              <div className="mt-5" />
              <h4 className="text-baseAssets">Lend CHAU</h4>
              <div className="d-flex flex-column align-items-center">
                <P className="m-0">How many would you like to Lend?</P>
                <div className="my-3" />
                <label className="form-labe mb-2" style={{ color: "#EDC452" }}>
                  Avaliable Amount to Lend : {balance.toFixed(4)}CHAU
                </label>
                <div
