...
export const WthdrawLending = () => {
  ...
  useEffect(() => {
    const refreshData = async () => {
      try {
        const amountToWithdraw_Dai = await Utils.getLendPosition(
          address,
          "DAI",
        );
        setDai_chcBalance(Number(amountToWithdraw_Dai.lendAmount) / 1e18);

        const amountToWithdraw_Eth = await Utils.getLendPosition(
          address,
          "ETH",
        );
        setEth_chcBalance(Number(amountToWithdraw_Eth.lendAmount) / 1e18);
      } catch (error) {
        ...
        >
          <div className="col-md-6">
            ...
            >
              ...
              <h4 className="text-baseAssets">Withdraw Lend CHAU</h4>
