...
export const Liquidate = () => {
  ...
  const validationPopupProps = {
    ...
    buttonText: "Back",
    buttonLink: "/accounts/mintposition",
  };

  useEffect(() => {
    if (route == true) {
      navigate("/accounts/mintposition");
    }
  }, [route]);
  ...
  const liquidate = async () => {
    try {
      if (isConnected && amount) {
        ...
        let checkAllowance = await chrysusContract.allowance(address, CHRYSUS);

        if (amount > Number(checkAllowance) / 1e18) {
          Txn = await chrysusContract.approve(
            CHRYSUS,
        ...
        <div className="d-flex">
          ...
          >
            <div className="col-lg-6">
              ...
              >
                <div className="mt-5" />
                <h4 className="text-baseAssets">Liquidate</h4>
                <div className="d-flex flex-column align-items-start">
                  <P className="m-0">How much would you like to Liquidate?</P>
                  <div className="my-3" />
                  <label className="form-label">
                    <span className="text-baseAssets">
                      Your CHAU Balance: {balance.toFixed(4)}
                    </span>
                  </label>
                  <div
                        ...
                        >
                          ...
                          <div className="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
                            <button
                              ...
                              type="button"
                              onClick={() =>
                                setIsConfirm(false) & setRoute(true)
                              }
                            >
                              ok
                            </button>
