...
export default function Code() {
  return (
    ...
    // <div className="md:py-20 py-10 text-white bg-[#437a45]">
      ...
      >
        <div className="">
          <p className="font-neue-plak leading-7 xss:leading-8 xs:leading-[2.25rem] xl:leading-none text-[1.35rem] xss:text-2xl xs:text-[28px] sm:text-4xl md:text-[42px] xl:text-5xl xs:mb-5 mb-3">
           Emerging{" "}
          ...
          <p className="text-xs sm:text-sm md:text-base lg:text-lg w-[90%]">
          ...
          <button className={styles["api-button"]}>
